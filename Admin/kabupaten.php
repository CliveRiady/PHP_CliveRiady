...
if (isset($_POST['Simpan'])) {
    ...
    if (($ekstensifile == "jpg") or ($ekstensifile == "JPG")) {
        ...
        mysqli_query($connection, "insert into kabupaten values ('$kabupatenkode', '$namakabupaten', '$alamat', '$keterangan','$nama', '$ketfotoicon')");
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($query)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="kabupatenedit.php?ubahkabupaten=<?php echo $row['kabupatenKODE'] ?>" class="btn btn-success btn-sm" title="EDIT">
