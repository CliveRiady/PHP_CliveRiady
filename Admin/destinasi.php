                ...
                <div class="col-sm-10">
                    ...
                    <form method="POST">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="inputkode" id="kodedestinasi" placeholder="Kode Destinasi" maxlength="4">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="destinasialamat" id="destinasialamat" placeholder="Alamat Destinasi">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="kodearea" class="form-control" id="kodearea">
                                    <option value="">Area Wisata</option>
